 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme WpThemeBoilerplate
...
add_action('tgmpa_register', 'wp_theme_boilerplate_register_required_plugins');
 ...
 */
function wp_theme_boilerplate_register_required_plugins()
{
    /*
    ...
    $plugins = array(
        ...
        // 	'source'       => 'https://downloads.wordpress.org/plugin/redux-framework.4.3.3.zip, // The plugin source.
        // 	'required'     => true, // If false, the plugin is only 'recommended' instead of required.
        ...
        array(
            'name' => esc_html__('WP Bakery Visual Composer', 'mytheme'), // The plugin name.
